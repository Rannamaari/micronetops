                    ...
                    <form method="POST" action="{{ route('expenses.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="account_id" class="mt-1 w-full rounded border-gray-300" required>
                                <x-expense-account-options :accounts="$accounts" />
                            </select>
                                            ...
                                            <div class="purchase-row rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
                                                <div class="grid grid-cols-1 sm:grid-cols-12 gap-4">
                                                    ...
                                                    <div class="sm:col-span-4">
                                                        ...
                                                        <input name="purchases[{{ $index }}][name]" class="mt-1 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-base h-12 px-4 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 inventory-item-name" value="{{ $purchase['name'] ?? '' }}" placeholder="New item name">
                                                    ...
                                                    <div class="sm:col-span-3">
                                                        ...
                                                        <input name="purchases[{{ $index }}][sku]" class="mt-1 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-base h-12 px-4 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 inventory-item-sku" value="{{ $purchase['sku'] ?? '' }}" placeholder="SKU">
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        ...
                                                        <input name="purchases[{{ $index }}][unit]" class="mt-1 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 text-base h-12 px-4 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="{{ $purchase['unit'] ?? '' }}" placeholder="pcs">
