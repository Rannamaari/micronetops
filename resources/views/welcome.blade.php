    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">MicroNET Sales - Garage Operations Management System
                </p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            Get started with MicroNET Sales
                        </span>
                    </li>
                </ul>
            </div>
            <div
                ...
                @if(file_exists(public_path('logo.png')))
                    <img src="{{ asset('logo.png') }}" alt="MicroNET Logo"
                        class="w-full h-auto max-w-[80%] transition-all translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-6">
                @else
                    <div
                        class="w-full text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6 text-6xl font-bold text-center">
                        MicroNET
                    </div>
                @endif
                <div
