                    ...
                    <div class="flex justify-between items-start mb-4 sm:mb-3">
	                    ...
	                    @if($customer->gst_number)
	                        <div class="mt-3 flex items-start gap-3 p-3 sm:p-2.5 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
	                            ...
	                            <div class="flex-1">
	                                <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">GST No</div>
	                                <div class="text-base sm:text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $customer->gst_number }}</div>
	                            </div>
	                        </div>
	                    @endif
